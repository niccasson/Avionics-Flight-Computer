...
void spi3_init(SPI_HandleTypeDef *hspi){
	  ...
	  */
	    ...
	    //Setup the SPI MOSI,MISO and SCK. These pins are fixed.
	    GPIO_InitStruct.Pin = IMU_SPI_MOSI_PIN|IMU_SPI_MISO_PIN|IMU_SPI_SCK_PIN;
	    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
	    GPIO_InitStruct.Pull = GPIO_NOPULL;
	    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_VERY_HIGH;
	    ...
	    //Setup the SPI CS. This can be any pin.
	    GPIO_InitStruct.Pin = IMU_SPI_ACC_CS_PIN;
	    GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
	    GPIO_InitStruct.Pull = GPIO_NOPULL;
	    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_VERY_HIGH;
	    GPIO_InitStruct.Alternate = 0;

	    HAL_GPIO_Init(IMU_SPI_ACC_CS_PORT,&GPIO_InitStruct);
